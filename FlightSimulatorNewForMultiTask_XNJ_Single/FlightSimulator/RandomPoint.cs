...
namespace Game
{
    class RandomPoint
    {
        ...
        private int stripWidth = 1024/16;
        ...
        public Bitmap getGreyImage(float degree,bool switchState)
        {
            ...
            for (int i = 0; i != 16; i++)
            {
                    ...
                    if (i % 2 == 0)
                    {
                        ...
                        if (switchState)
                        {
                            g.FillRectangle(new SolidBrush(Color.FromArgb(35, Color.Black)), (i * 64 + position) % width, 0, stripWidth, height);
                        }
                        else
                        {
                            g.FillRectangle(new SolidBrush(Color.FromArgb(219, Color.Black)), (i * 64 + position) % width, 0, stripWidth, height);
                        }

                    }
                    else
                    {
                        g.FillRectangle(new SolidBrush(Color.FromArgb(127, Color.Black)), (i * 64 + position) % width, 0, stripWidth, height);
                    }
